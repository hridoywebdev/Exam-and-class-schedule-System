...
<?php
			...
			$result = mysqli_query($conn,"SELECT `faculty`,`course`, `subject` FROM `faculty`,`course`,`subject`, WHERE faculty_id=faculty_id and course_id=course_id and subject_id=subject_id");
